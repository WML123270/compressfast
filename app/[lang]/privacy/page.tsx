    ...
    <div className="max-w-3xl mx-auto px-4 py-8 sm:py-12 space-y-6">
      ...
      <div className="prose prose-sm max-w-none text-neutral-700 space-y-6">
        <section>
          ...
          <h3 className="font-medium text-neutral-800 mt-4">{isZh ? '1.1 我们不收集的信息' : '1.1 What We DO NOT Collect'}</h3>
          ...
          <h3 className="font-medium text-neutral-800 mt-4">{isZh ? '1.2 我们收集的有限信息' : '1.2 What We DO Collect'}</h3>
          <ul className="space-y-1">
