...
export function ImageCompare({ beforeSrc, afterSrc, beforeLabel, afterLabel }: ImageCompareProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full aspect-video overflow-hidden rounded-lg bg-white select-none touch-none"
    ...
    >
      ...
      <div className="absolute bottom-2 left-2 pointer-events-none">
        <span className="px-2 py-0.5 font-medium rounded bg-black/10 text-white backdrop-blur-sm">
          {beforeLabel}
        </span>
      </div>
